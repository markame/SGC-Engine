...
namespace SGC
{
	public class FormBfirma : Form
	{
		...
		private void FormBfirma_Load(object sender, EventArgs e)
		{
		}
		...
		private void InitializeComponent()
		{
			...
			cbpor.TabIndex = 3;
			cbpor.SelectedIndexChanged += new System.EventHandler(cbpor_SelectedIndexChanged);
			txcampo.Location = new System.Drawing.Point(44, 14);
			txcampo.Name = "txcampo";
			txcampo.Size = new System.Drawing.Size(218, 20);
			txcampo.TabIndex = 2;
			txcampo.TextChanged += new System.EventHandler(txcampo_TextChanged);
			...
			dgbuscaFirma.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(dataGridView1_CellContentClick);
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.MaximizeBox = false;
			base.ClientSize = new System.Drawing.Size(505, 269);
			base.Controls.Add(panel1);
			base.MinimizeBox = false;
			base.Name = "FormBfirma";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "Busca Firma ";
			base.Load += new System.EventHandler(FormBfirma_Load);
