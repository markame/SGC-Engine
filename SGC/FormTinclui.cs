...
namespace SGC
{
	public class FormTinclui : Form
	{
		...
		public FormTinclui()
		{
			...
			tb_cod.Text = openconector.NumberRows("SELECT COUNT(*) FROM usuario").ToString();
		}
		...
		private void btn_save_Click(object sender, EventArgs e)
		{
			...
			string queryInsere = "INSERT INTO usuario (nome,funcao,data,email,usuario,senha,observacao)VALUES('" + nome + "','" + funcao + "','" + data_entrada + "','" + email + "','" + usuario + "','" + senha + "','" + obser + "')";
			string querySelect = "SELECT * FROM usuario WHERE usuario='" + usuario + "'";
			openconector.INSEREGENERIC(queryInsere);
			tb_funcao.Text = "";
			ms_data.Text = "";
			tb_nome.Text = "";
			tb_usuario.Text = "";
		...
		private void FormTinclui_Load(object sender, EventArgs e)
		{
		}
		...
		private void tb_funcao_SelectedIndexChanged(object sender, EventArgs e)
		{
		}
		...
		private void InitializeComponent()
		{
			...
			tb_funcao = new System.Windows.Forms.ComboBox();
			...
			tb_funcao.Items.AddRange(new object[3] { "Tabelião", "Escrevente", "Secretario" });
			tb_funcao.Location = new System.Drawing.Point(248, 29);
			tb_funcao.Name = "tb_funcao";
			tb_funcao.Size = new System.Drawing.Size(121, 21);
			tb_funcao.TabIndex = 4;
			tb_funcao.SelectedIndexChanged += new System.EventHandler(tb_funcao_SelectedIndexChanged);
			...
			tb_cod.TabIndex = 3;
			tb_cod.TextChanged += new System.EventHandler(textBox1_TextChanged);
			...
			base.ClientSize = new System.Drawing.Size(624, 406);
			base.Controls.Add(panel1);
			base.MinimizeBox = false;
			base.Name = "FormTinclui";
			base.ShowInTaskbar = false;
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "FormTinclui";
			base.Load += new System.EventHandler(FormTinclui_Load);
