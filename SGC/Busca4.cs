...
namespace SGC
{
	public class Busca4 : Form
	{
		...
		private void Busca4_Load(object sender, EventArgs e)
		{
		}
		...
		public void Plista(string where, string find)
		{
			...
			selectuser.DAO();
			string query = "SELECT id_firma, nome , autografo , d_renovacao ,roconheciada ,validade , cep , cidade , uf , sexo , civil , profissao , d_nascimento , cpf , cgc , indentidade , controle ,observ FROM firma WHERE " + where + " = '" + find + "'";
			try
			{
				DataTable firma = new DataTable();
				selectuser.SELECTGENERIC(query).Fill(firma);
				dgbuscaFirma.DataSource = firma;
			}
		...
		private void dgbuscaFirma_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
		{
			DataGridViewRow row = dgbuscaFirma.Rows[e.RowIndex];
			string Nfirma = row.Cells["Nome"].Value.ToString();
			dados newd = new dados();
			newd.SetFirma2(Nfirma);
			Close();
			FormPrintAutenticidade frma = new FormPrintAutenticidade();
			frma.ShowDialog();
		}
		...
		private void InitializeComponent()
		{
			...
			dgbuscaFirma.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(dgbuscaFirma_CellContentClick_1);
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.MaximizeBox = false;
			base.ClientSize = new System.Drawing.Size(505, 265);
			base.Controls.Add(panel1);
			base.MinimizeBox = false;
			base.Name = "Busca4";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "Busca Firma";
			base.Load += new System.EventHandler(Busca4_Load);
